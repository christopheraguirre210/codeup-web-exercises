$(document).ready(function(){
    ...
    // console.log($.ajax("https://hookb.in/mZz1MagzMmTBVLpJXdWr?username=Bob"));
    ...
    // console.log($.ajax("https://hookb.in/mZz1MagzMmTBVLpJXdWr", person));
    ...
    // console.log($.ajax("https://hookb.in/mZz1MagzMmTBVLpJXdWr", user));
    ...
    forceAwakens.done(function (data) {
        console.log("The release date for The Force Awakens is " + data.results[0].release_date);
    });
    ...
    var canteburyTales = $.ajax("data/books.json");


    canteburyTales.done(function (data) {
        var theAuthor;
